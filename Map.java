...
public class Map {
	...
	// method that finds the path for dijkstra's algorithm 
	...
	//method that finds total distance needed to travel between the intersections
	...
	//method that computes the roads used to find the minimum weight spanning set
